import { ShenaiSdkState } from "@/app/(app)/shenai-playground/page";
import dynamic from "next/dynamic";
import { CodeSnippet } from "./CodeSnippet";
import styles from "@/app/(app)/styles/Home.module.css";

const HeartbeatsPreview = dynamic(() => import("./HeartbeatsPreview"), {
  ssr: false,
});

const PPGPreview = dynamic(() => import("./PPGPreview"), {
  ssr: false,
});
